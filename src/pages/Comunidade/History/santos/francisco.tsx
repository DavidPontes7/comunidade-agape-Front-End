        ...
        <div className="container mx-auto py-8 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <img src='https://github.com/AdsonVicente/ImagensUrlDados/blob/main/sao-francisco-de-assis-.jpg?raw=true' alt="São Francisco de Assis" className="w-50 h-80 mx-auto mb-4 shadow-lg" />
                ...
                <div>
                    ...
                    <p className="text-gray-700">
                        Francisco nasceu em Assis, na Úmbria (Itália) em 1182. Jovem orgulhoso, vaidoso e rico, que se tornou o mais italiano dos santos e o mais santo dos italianos. <br /><br />Com 24 anos, renunciou a toda riqueza para desposar a “Senhora Pobreza”.
                        Aconteceu que Francisco foi para a guerra como cavaleiro, mas doente ouviu e obedeceu a voz do Patrão que lhe dizia: “Francisco, a quem é melhor servir, ao amo ou ao criado?”. Ele respondeu que ao amo. “Porque, então, transformas o amo em criado?”, replicou a voz.<br /> <br />No início de sua conversão, foi como peregrino a Roma, vivendo como eremita e na solidão, quando recebeu a ordem do Santo Cristo na igrejinha de São Damião: “Vai restaurar minha igreja, que está em ruínas”.
                        ...
                        <br /> <br /> Em 1223, foi a Roma e obteve a aprovação mais solene da Regra, como ato culminante da sua vida. Na última etapa de sua vida, recebeu no Monte Alverne os estigmas de Cristo, em 1224.
                ...
                <div className="mt-8">
                    ...
                    <p className="text-gray-700 ">
                        São Francisco é baluarte da Comunidade para ensinar aos seus membros sobre a pobreza e a necessidade de despojamento. <br />
                        <br />
                        Rezemos juntos a oração de São Francisco<br />
