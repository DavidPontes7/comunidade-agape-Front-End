...
export default function SummerCampBanner() {
  ...
  return (
    <>
      {isBannerOpen && (
         <div className="fixed top-0 w-full z-50 bg-blue-400 text-gray-900 px-6 py-3 flex justify-between items-center">
